...
import {WishlistItemCreateDialogComponent} from "../wishlist-item-create-dialog/wishlist-item-create-dialog.component";
import {ModalService} from "../../../shared/modal/services/modal.service";

@Component({
    selector: 'app-wishlist-item-create',
    standalone: true,
    imports: [
...
export class WishlistItemCreateCardComponent {
    ...
    onAddClicked() {
        this.modalService.open(WishlistItemCreateDialogComponent)
            .subscribe(output => {
                if (output.hasResult) {
                    this.onCreated.emit();
                }
